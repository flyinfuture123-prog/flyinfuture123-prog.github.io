...
SPECTRA = {
    ...
    "curves": [
        {"id": "blue450", "name": "藍光 LED 晶片", "short": "藍光晶片", "formula": "InGaN", "peak": 450, "fwhm": 25, "color": "藍", "rel": 0.9, "note": "白光 LED 的激發光源（半高寬約 20–30 nm）；沒被螢光粉吸收的部分直接成為白光中的藍色成分。"},
        {"id": "violet405", "name": "紫光 LED 晶片", "short": "紫光晶片", "formula": "InGaN", "peak": 405, "fwhm": 15, "color": "紫", "rel": 0.6, "note": "「全光譜」「類太陽光」LED 常用紫光晶片激發紅綠藍三種螢光粉，藍光成分改由螢光粉提供，較不刺眼。"},
        ...
        {"id": "ksf", "name": "KSF:Mn⁴⁺ 紅色螢光粉", "short": "KSF", "formula": "K2SiF6:Mn4+", "peak": 631, "fwhm": 5, "color": "紅", "note": "錳(IV)氟化物線狀發光，實際上是 600–650 nm 之間的多條細線（此處以主峰示意），色純度極高，是廣色域背光與高顯色照明的主力紅色。"},
        ...
        {"id": "farred", "name": "遠紅光螢光粉（植物用）", "short": "遠紅光", "formula": "例如 LaAlO3–Al2O3:Cr3+、CaAl12O19:Cr3+ 等 Cr3+ 材料", "peak": 735, "fwhm": 80, "color": "遠紅", "note": "植物的光敏素對 730 nm 附近的遠紅光有反應，園藝燈用它調節開花與株型；Cr³⁺ 遠紅光螢光粉的內部量子效率已可達 98%。"},
